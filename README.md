...
Uso rapido
Apri `index.html` (doppio clic, oppure pubblicato via GitHub Pages — vedi sotto)
Trascina il file `.log` / `.txt` nell'area di caricamento
Filtra per data, operatore, tipo operazione o testo
Esporta il risultato filtrato in CSV con il bottone in basso
